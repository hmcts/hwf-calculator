  ...
  module Test
    module En
      class NumberOfChildrenPage < BasePage
        ...
        section :number_of_children, ::Calculator::Test::NumberOfChildrenQuestionSection, :calculator_question, t('hwf_pages.number_of_children.questions.number_of_children.label')
