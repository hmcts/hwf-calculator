  ...
  module Test
    module En
      class DisposableCapitalPage < BasePage
        ...
        section :disposable_capital, ::Calculator::Test::DisposableCapitalQuestionSection, :calculator_question, t('hwf_pages.disposable_capital.questions.disposable_capital.label')
