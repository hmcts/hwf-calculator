...
module Calculator
  module Test
    class DisposableCapitalQuestionSection < QuestionNumericSection
      section :help_section, QuestionHelpSection, :help_section_labelled, 'Help with savings and investments'
