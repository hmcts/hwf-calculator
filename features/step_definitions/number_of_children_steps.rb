Given("I am on the of children page") do
  ...
  step 'I submit the page with income related benefit checked'
end
...
Then("on the next page I should see my previous answer with our number of children") do |int|
...
Then("I should see the number of children error message") do
  binding.pry
  expect(number_of_children_page.error_with_text(messaging.t('hwf_pages.number_of_children_page.errors.blank'))).to be_present
end